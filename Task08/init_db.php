...
try {
    ...
    // Создаем таблицу выполненных услуг
    $pdo->exec("CREATE TABLE IF NOT EXISTS completed_services (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        master_id INTEGER NOT NULL,
    ...
    if ($count == 0) {
        ...
        // Добавляем выполненные услуги
        $pdo->exec("INSERT INTO completed_services (master_id, client_name, service_name, service_date, price) VALUES
